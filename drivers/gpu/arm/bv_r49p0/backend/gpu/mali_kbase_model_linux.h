 ...
 * @kbdev: Kbase device.
 *
 * Specific model hook is implemented by bv_r49p0_model_create()
 *
 ...
 * @kbdev: Kbase device.
 *
 * Specific model hook is implemented by bv_r49p0_model_destroy()
 */
void kbase_gpu_device_destroy(struct kbase_device *kbdev);

/**
 * bv_r49p0_model_create() - Private create function.
 *
 * @kbdev: Kbase device.
 *
...
/**
 * bv_r49p0_model_destroy() - Private destroy function.
 *
 * @h: Model handle.
 *
 * This hook is specific to the model built in Kbase.
...
/**
 * bv_r49p0_model_write_reg() - Private model write function.
 *
 * @h: Model handle.
...
/**
 * bv_r49p0_model_read_reg() - Private model read function.
 *
 * @h: Model handle.
